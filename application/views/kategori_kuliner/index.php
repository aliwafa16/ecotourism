                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <a href="" type="button" class="btn add_button mb-3" id="btn_addKategori"><i class="fa fa-plus"></i>Tambah data</a>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover" id="table_kategori_kuliner" style="width:100%">
                                        <thead>
                                            <tr class="text-center">
                                                <th scope="col">No</th>
                                                <th scope="col">Kategori kuliner</th>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="btn_submitKategori" class="btn btn-primary">Tambah</button>
                    </div>
                    </form>
                </div>
            </div>
        ...
        <script src="<?= base_url() ?>js/kategori_kuliner.js"></script>