        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <button type="button" class="btn add_button m-2 btn-sm" id="btn_addWisata" onclick="item_kuliner(document.querySelector('#id_kuliner').value)"><i class="fa fa-plus"></i>Tambah data</button>
                                <div class="table-responsive">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <button type="button" class="btn add_button m-2 btn-sm float-center" onclick="gambar_kuliner(document.querySelector('#id_kuliner').value)"><i class="fas fa-plus"></i> Tambah data</button>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form action="" method="POST" enctype="multipart/form-data" id="form_gambar">
                                    <input type="hidden" class="kuliner_id" name="id_pariwisata">
        ...
        <script>
            ...
            function edit_menu(id_menu_kuliner) {
                ...
                $.ajax({
                    url: API + 'menu_kuliner/' + id_menu_kuliner,
                    type: 'GET',
                    dataType: 'JSON',
                    success: function(results) {
                        let data = results.data;
