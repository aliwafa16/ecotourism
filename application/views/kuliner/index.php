                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <a href="<?= base_url() ?>Kuliner/tambah" type="button" class="btn add_button mb-3" id="btn_addWisata"><i class="fa fa-plus"></i>Tambah data</a>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover" id="table_kuliner" width="100%">
                                        <thead>
                                            <tr>
                                                <th scope="col">No</th>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form action="" method="POST" enctype="multipart/form-data" id="form_item">
                                    <input type="hidden" class="kuliner_id" name="id">
                                    <div>
