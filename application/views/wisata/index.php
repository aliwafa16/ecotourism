                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <button type="button" class="btn add_button mb-3" id="btn_addWisata"><i class="fa fa-plus"></i>Tambah data</button>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover" id="table_wisata" style="width: 120%;">
                                        <thead>
                                            <tr>
                                                <th scope="col">No</th>
