        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <button type="button" class="btn add_button m-2 btn-sm" id="btn_addWisata" onclick="item_wisata(document.querySelector('#id_wisata').value)"><i class="fa fa-plus"></i>Tambah data</button>
                                <div class="table-responsive">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <button type="button" class="btn add_button m-2 btn-sm float-center" onclick="gambar_wisata(document.querySelector('#id_wisata').value)"><i class="fas fa-plus"></i> Tambah data</button>
