            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4">
                    <div class="login-wrap p-0">
                        <h3 class="mb-4 text-center">Kode Ubah Password</h3>
                        <p class="text-center">Silahkan masukan kode</p>
                        <form action="" class="signin-form" enctype="multipart/form-data" id="form_sendEmail">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Kode ubah kata sandi" required id="email" name="email" autocomplete="off">
