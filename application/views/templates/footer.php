...
<!--chartis chart-->
<script src="<?= base_url('assets/backend') ?>/assets/libs/chartist/dist/chartist.min.js"></script>
<script src="<?= base_url('assets/backend') ?>/assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js"></script>
